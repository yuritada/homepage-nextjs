...
**認証必須の資産をブラウザで表示するための定石**であり、[第 15 章 / 第 2 回](/blog/2026-09-01-mirais-02-design)の公開遮断ポリシーを崩さずに認証ユーザーへ表示するための実装上の要になっています。「ポスターを認証必須にする」という判断は、こういう実装コストとセットで引き受けるものだ、というのが学びでした。
