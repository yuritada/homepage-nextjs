...
date: "2026-08-31"
tags: ["AI", "Claude", "開発体験", "LT"]
summary: "夏休みにClaude Max 5xへ課金し、自律AIエージェント組織「claude-factory」を作った結果、開発体験が虚無になった話。そこから辿り着いた「ループエンジニアリング」という発散と収束のバランスについてまとめます。"
...
先日、桜井政博さんの動画に強烈に背中を突き飛ばされ、**「当日思い立って30分でスライドを作って5分LTをする」** という勢いだけの登壇をしてきました。

今回は、そのLTでお話しした **「夏休みのAI課金と開発体験の試行錯誤」** について、ブログ記事としてまとめ直してみます。

## きっかけ：「とにかくやれ!!」に突き飛ばされた日

すべての始まりは、ゲームクリエイター・桜井政博さんのYouTube動画でした。

- 参考動画: [ゲームを作るには【企画・ゲーム設計】](https://youtu.be/JV3KOJ_Z4Vs)

画面越しに「とにかくやれ!!」「いますぐ支度して出るんだ!!」と怒涛の勢いで言われた気がして、気づけばその日のLT枠に飛び込み、30分でスライドを作っていました。
...
- **[`claude-factory`](https://github.com/yuritada/claude-factory)** - 今回封印した自律AIエージェント組織（GitHub）
