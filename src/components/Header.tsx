  ...
  return (
    <header id="home" className="relative min-h-[100svh] flex flex-col items-center justify-center text-center overflow-hidden py-24">
      ...
      <div className="relative z-10 flex flex-col items-center w-full px-5">
        ...
        {/* Catchphrase */}
        <p className="font-display font-black text-accent text-2xl sm:text-3xl md:text-5xl tracking-wide mb-8 md:mb-10 max-w-2xl min-h-[2.25rem] sm:min-h-[2.75rem] md:h-16 px-2 drop-shadow-[0_0_18px_rgba(255,215,0,0.25)]">
          {subtitle}
